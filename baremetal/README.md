# SysTick programming: Baremetal project in Embedded C
...
### Control flow
![Control flow diagram for SysTick timer](https://github.com/csrohit/bluepill-systick/blob/main/baremetal/docs/filled.png "SysTick timer - control flow diagram")
